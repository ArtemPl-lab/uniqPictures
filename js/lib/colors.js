...
const initializeColors = () => {
    ...
    const colors_blocks = colors.reduce((acc, curr, currInd)=>acc+=`
        <input type="radio" name="border_color" id="id_${currInd}" class="custom-dropdown__checkbox" value="${JSON.stringify(hexToRgb(curr.hex))}">
        <label for="id_${currInd}" class="custom-dropdown__checkbox-label">${curr.name}</label>
    `, '');
    dropdown.insertAdjacentHTML('afterbegin', colors_blocks);
}